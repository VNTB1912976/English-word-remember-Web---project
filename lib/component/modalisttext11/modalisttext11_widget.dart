...
import 'modalisttext11_model.dart';
export 'modalisttext11_model.dart';

class Modalisttext11Widget extends StatefulWidget {
  const Modalisttext11Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext11Widget> createState() => _Modalisttext11WidgetState();
}

class _Modalisttext11WidgetState extends State<Modalisttext11Widget> {
  late Modalisttext11Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext11Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv1Record>>(
      stream: queryVocalistLv1Record(
        queryBuilder: (vocalistLv1Record) => vocalistLv1Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv1Record> containerVocalistLv1RecordList = snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv1RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv1Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal1(
                                            containerVocalistLv1RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv1Record>();
                                    setState(() {});
                                  },
