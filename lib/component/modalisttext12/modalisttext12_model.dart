...
import 'modalisttext12_widget.dart' show Modalisttext12Widget;
import 'package:flutter/material.dart';

class Modalisttext12Model extends FlutterFlowModel<Modalisttext12Widget> {
  ///  Local state fields for this component.

  List<VocalistLv2Record> promotevoca = [];
  void addToPromotevoca(VocalistLv2Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv2Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv2Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv2Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv2Record>();
