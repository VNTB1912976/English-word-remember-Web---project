...
import 'modalisttext13_widget.dart' show Modalisttext13Widget;
import 'package:flutter/material.dart';

class Modalisttext13Model extends FlutterFlowModel<Modalisttext13Widget> {
  ///  Local state fields for this component.

  List<VocalistLv3Record> promotevoca = [];
  void addToPromotevoca(VocalistLv3Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv3Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv3Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv3Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv3Record>();
