...
import 'modalisttext13_model.dart';
export 'modalisttext13_model.dart';

class Modalisttext13Widget extends StatefulWidget {
  const Modalisttext13Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext13Widget> createState() => _Modalisttext13WidgetState();
}

class _Modalisttext13WidgetState extends State<Modalisttext13Widget> {
  late Modalisttext13Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext13Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv3Record>>(
      stream: queryVocalistLv3Record(
        queryBuilder: (vocalistLv3Record) => vocalistLv3Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv3Record> containerVocalistLv3RecordList = snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv3RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv3Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal3(
                                            containerVocalistLv3RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv3Record>();
                                    setState(() {});
                                  },
