...
import 'modalisttext14_widget.dart' show Modalisttext14Widget;
import 'package:flutter/material.dart';

class Modalisttext14Model extends FlutterFlowModel<Modalisttext14Widget> {
  ///  Local state fields for this component.

  List<VocalistLv4Record> promotevoca = [];
  void addToPromotevoca(VocalistLv4Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv4Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv4Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv4Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv4Record>();
