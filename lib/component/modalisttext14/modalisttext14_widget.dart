...
import 'modalisttext14_model.dart';
export 'modalisttext14_model.dart';

class Modalisttext14Widget extends StatefulWidget {
  const Modalisttext14Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext14Widget> createState() => _Modalisttext14WidgetState();
}

class _Modalisttext14WidgetState extends State<Modalisttext14Widget> {
  late Modalisttext14Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext14Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv4Record>>(
      stream: queryVocalistLv4Record(
        queryBuilder: (vocalistLv4Record) => vocalistLv4Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv4Record> containerVocalistLv4RecordList = snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv4RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv4Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal4(
                                            containerVocalistLv4RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv4Record>();
                                    setState(() {});
                                  },
