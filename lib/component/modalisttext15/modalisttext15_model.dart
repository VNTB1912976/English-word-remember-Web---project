...
import 'modalisttext15_widget.dart' show Modalisttext15Widget;
import 'package:flutter/material.dart';

class Modalisttext15Model extends FlutterFlowModel<Modalisttext15Widget> {
  ///  Local state fields for this component.

  List<VocalistLv5Record> promotevoca = [];
  void addToPromotevoca(VocalistLv5Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv5Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv5Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv5Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv5Record>();
