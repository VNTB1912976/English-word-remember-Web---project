...
import 'modalisttext15_model.dart';
export 'modalisttext15_model.dart';

class Modalisttext15Widget extends StatefulWidget {
  const Modalisttext15Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext15Widget> createState() => _Modalisttext15WidgetState();
}

class _Modalisttext15WidgetState extends State<Modalisttext15Widget> {
  late Modalisttext15Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext15Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv5Record>>(
      stream: queryVocalistLv5Record(
        queryBuilder: (vocalistLv5Record) => vocalistLv5Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv5Record> containerVocalistLv5RecordList = snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv5RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv5Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal5(
                                            containerVocalistLv5RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv5Record>();
                                    setState(() {});
                                  },
