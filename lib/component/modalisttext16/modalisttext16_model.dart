...
import 'modalisttext16_widget.dart' show Modalisttext16Widget;
import 'package:flutter/material.dart';

class Modalisttext16Model extends FlutterFlowModel<Modalisttext16Widget> {
  ///  Local state fields for this component.

  List<VocalistLv6Record> promotevoca = [];
  void addToPromotevoca(VocalistLv6Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv6Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv6Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv6Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv6Record>();
