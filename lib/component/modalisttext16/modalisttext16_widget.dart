...
import 'modalisttext16_model.dart';
export 'modalisttext16_model.dart';

class Modalisttext16Widget extends StatefulWidget {
  const Modalisttext16Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext16Widget> createState() => _Modalisttext16WidgetState();
}

class _Modalisttext16WidgetState extends State<Modalisttext16Widget> {
  late Modalisttext16Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext16Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv6Record>>(
      stream: queryVocalistLv6Record(
        queryBuilder: (vocalistLv6Record) => vocalistLv6Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv6Record> containerVocalistLv6RecordList = snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv6RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv6Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal6(
                                            containerVocalistLv6RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv6Record>();
                                    setState(() {});
                                  },
