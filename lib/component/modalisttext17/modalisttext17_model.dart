...
import 'modalisttext17_widget.dart' show Modalisttext17Widget;
import 'package:flutter/material.dart';

class Modalisttext17Model extends FlutterFlowModel<Modalisttext17Widget> {
  ///  Local state fields for this component.

  List<VocalistLv7Record> promotevoca = [];
  void addToPromotevoca(VocalistLv7Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv7Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv7Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv7Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv7Record>();
