...
import 'modalisttext17_model.dart';
export 'modalisttext17_model.dart';

class Modalisttext17Widget extends StatefulWidget {
  const Modalisttext17Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext17Widget> createState() => _Modalisttext17WidgetState();
}

class _Modalisttext17WidgetState extends State<Modalisttext17Widget> {
  late Modalisttext17Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext17Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv7Record>>(
      stream: queryVocalistLv7Record(
        queryBuilder: (vocalistLv7Record) => vocalistLv7Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv7Record> containerVocalistLv7RecordList = snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv7RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv7Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal7(
                                            containerVocalistLv7RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv7Record>();
                                    setState(() {});
                                  },
