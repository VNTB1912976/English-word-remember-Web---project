...
import 'modalisttext18_widget.dart' show Modalisttext18Widget;
import 'package:flutter/material.dart';

class Modalisttext18Model extends FlutterFlowModel<Modalisttext18Widget> {
  ///  Local state fields for this component.

  List<VocalistLv8Record> promotevoca = [];
  void addToPromotevoca(VocalistLv8Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv8Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv8Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv8Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv8Record>();
