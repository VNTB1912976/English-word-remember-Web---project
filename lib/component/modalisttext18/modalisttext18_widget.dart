...
import 'modalisttext18_model.dart';
export 'modalisttext18_model.dart';

class Modalisttext18Widget extends StatefulWidget {
  const Modalisttext18Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext18Widget> createState() => _Modalisttext18WidgetState();
}

class _Modalisttext18WidgetState extends State<Modalisttext18Widget> {
  late Modalisttext18Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext18Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv8Record>>(
      stream: queryVocalistLv8Record(
        queryBuilder: (vocalistLv8Record) => vocalistLv8Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv8Record> containerVocalistLv8RecordList = snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv8RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv8Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal8(
                                            containerVocalistLv8RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv8Record>();
                                    setState(() {});
                                  },
