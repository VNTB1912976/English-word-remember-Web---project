...
import 'modalisttext19_model.dart';
export 'modalisttext19_model.dart';

class Modalisttext19Widget extends StatefulWidget {
  const Modalisttext19Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext19Widget> createState() => _Modalisttext19WidgetState();
}

class _Modalisttext19WidgetState extends State<Modalisttext19Widget> {
  late Modalisttext19Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext19Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv9Record>>(
      stream: queryVocalistLv9Record(
        queryBuilder: (vocalistLv9Record) => vocalistLv9Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv9Record> containerVocalistLv9RecordList = snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv9RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv9Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal9(
                                            containerVocalistLv9RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv9Record>();
                                    setState(() {});
                                  },
