...
import 'modalisttext21_model.dart';
export 'modalisttext21_model.dart';

class Modalisttext21Widget extends StatefulWidget {
  const Modalisttext21Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext21Widget> createState() => _Modalisttext21WidgetState();
}

class _Modalisttext21WidgetState extends State<Modalisttext21Widget> {
  late Modalisttext21Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext21Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv12Record>>(
      stream: queryVocalistLv12Record(
        queryBuilder: (vocalistLv12Record) => vocalistLv12Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv12Record> containerVocalistLv12RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv12RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv12Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal21(
                                            containerVocalistLv12RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv12Record>();
                                    setState(() {});
                                  },
