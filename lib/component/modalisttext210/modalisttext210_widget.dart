...
import 'modalisttext210_model.dart';
export 'modalisttext210_model.dart';

class Modalisttext210Widget extends StatefulWidget {
  const Modalisttext210Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext210Widget> createState() => _Modalisttext210WidgetState();
}

class _Modalisttext210WidgetState extends State<Modalisttext210Widget> {
  late Modalisttext210Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext210Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv11Record>>(
      stream: queryVocalistLv11Record(
        queryBuilder: (vocalistLv11Record) => vocalistLv11Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv11Record> containerVocalistLv11RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv11RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv11Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal20(
                                            containerVocalistLv11RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv11Record>();
                                    setState(() {});
                                  },
