...
import 'modalisttext22_model.dart';
export 'modalisttext22_model.dart';

class Modalisttext22Widget extends StatefulWidget {
  const Modalisttext22Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext22Widget> createState() => _Modalisttext22WidgetState();
}

class _Modalisttext22WidgetState extends State<Modalisttext22Widget> {
  late Modalisttext22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext22Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv13Record>>(
      stream: queryVocalistLv13Record(
        queryBuilder: (vocalistLv13Record) => vocalistLv13Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv13Record> containerVocalistLv13RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv13RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv13Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal22(
                                            containerVocalistLv13RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv13Record>();
                                    setState(() {});
                                  },
