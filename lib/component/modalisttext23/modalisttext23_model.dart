...
import 'modalisttext23_widget.dart' show Modalisttext23Widget;
import 'package:flutter/material.dart';

class Modalisttext23Model extends FlutterFlowModel<Modalisttext23Widget> {
  ///  Local state fields for this component.

  List<VocalistLv14Record> promotevoca = [];
  void addToPromotevoca(VocalistLv14Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv14Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv14Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv14Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv14Record>();
