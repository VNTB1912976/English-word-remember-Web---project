...
import 'modalisttext23_model.dart';
export 'modalisttext23_model.dart';

class Modalisttext23Widget extends StatefulWidget {
  const Modalisttext23Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext23Widget> createState() => _Modalisttext23WidgetState();
}

class _Modalisttext23WidgetState extends State<Modalisttext23Widget> {
  late Modalisttext23Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext23Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv14Record>>(
      stream: queryVocalistLv14Record(
        queryBuilder: (vocalistLv14Record) => vocalistLv14Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv14Record> containerVocalistLv14RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv14RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv14Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal23(
                                            containerVocalistLv14RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv14Record>();
                                    setState(() {});
                                  },
