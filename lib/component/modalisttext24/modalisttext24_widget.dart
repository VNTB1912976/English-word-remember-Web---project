...
import 'modalisttext24_model.dart';
export 'modalisttext24_model.dart';

class Modalisttext24Widget extends StatefulWidget {
  const Modalisttext24Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext24Widget> createState() => _Modalisttext24WidgetState();
}

class _Modalisttext24WidgetState extends State<Modalisttext24Widget> {
  late Modalisttext24Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext24Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv15Record>>(
      stream: queryVocalistLv15Record(
        queryBuilder: (vocalistLv15Record) => vocalistLv15Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv15Record> containerVocalistLv15RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv15RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv15Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal24(
                                            containerVocalistLv15RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv15Record>();
                                    setState(() {});
                                  },
