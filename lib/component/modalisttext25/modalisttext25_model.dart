...
import 'modalisttext25_widget.dart' show Modalisttext25Widget;
import 'package:flutter/material.dart';

class Modalisttext25Model extends FlutterFlowModel<Modalisttext25Widget> {
  ///  Local state fields for this component.

  List<VocalistLv16Record> promotevoca = [];
  void addToPromotevoca(VocalistLv16Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv16Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv16Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv16Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv16Record>();
