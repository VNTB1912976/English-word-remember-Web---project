...
import 'modalisttext25_model.dart';
export 'modalisttext25_model.dart';

class Modalisttext25Widget extends StatefulWidget {
  const Modalisttext25Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext25Widget> createState() => _Modalisttext25WidgetState();
}

class _Modalisttext25WidgetState extends State<Modalisttext25Widget> {
  late Modalisttext25Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext25Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv16Record>>(
      stream: queryVocalistLv16Record(
        queryBuilder: (vocalistLv16Record) => vocalistLv16Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv16Record> containerVocalistLv16RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv16RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv16Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal25(
                                            containerVocalistLv16RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv16Record>();
                                    setState(() {});
                                  },
