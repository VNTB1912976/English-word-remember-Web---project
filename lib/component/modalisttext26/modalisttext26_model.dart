...
import 'modalisttext26_widget.dart' show Modalisttext26Widget;
import 'package:flutter/material.dart';

class Modalisttext26Model extends FlutterFlowModel<Modalisttext26Widget> {
  ///  Local state fields for this component.

  List<VocalistLv17Record> promotevoca = [];
  void addToPromotevoca(VocalistLv17Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv17Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv17Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv17Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv17Record>();
