...
import 'modalisttext26_model.dart';
export 'modalisttext26_model.dart';

class Modalisttext26Widget extends StatefulWidget {
  const Modalisttext26Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext26Widget> createState() => _Modalisttext26WidgetState();
}

class _Modalisttext26WidgetState extends State<Modalisttext26Widget> {
  late Modalisttext26Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext26Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv17Record>>(
      stream: queryVocalistLv17Record(
        queryBuilder: (vocalistLv17Record) => vocalistLv17Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv17Record> containerVocalistLv17RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv17RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv17Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal26(
                                            containerVocalistLv17RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv17Record>();
                                    setState(() {});
                                  },
