...
import 'modalisttext27_widget.dart' show Modalisttext27Widget;
import 'package:flutter/material.dart';

class Modalisttext27Model extends FlutterFlowModel<Modalisttext27Widget> {
  ///  Local state fields for this component.

  List<VocalistLv18Record> promotevoca = [];
  void addToPromotevoca(VocalistLv18Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv18Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv18Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv18Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv18Record>();
