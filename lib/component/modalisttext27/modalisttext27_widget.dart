...
import 'modalisttext27_model.dart';
export 'modalisttext27_model.dart';

class Modalisttext27Widget extends StatefulWidget {
  const Modalisttext27Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext27Widget> createState() => _Modalisttext27WidgetState();
}

class _Modalisttext27WidgetState extends State<Modalisttext27Widget> {
  late Modalisttext27Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext27Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv18Record>>(
      stream: queryVocalistLv18Record(
        queryBuilder: (vocalistLv18Record) => vocalistLv18Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv18Record> containerVocalistLv18RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv18RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv18Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal27(
                                            containerVocalistLv18RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv18Record>();
                                    setState(() {});
                                  },
