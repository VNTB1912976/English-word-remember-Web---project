...
import 'modalisttext28_model.dart';
export 'modalisttext28_model.dart';

class Modalisttext28Widget extends StatefulWidget {
  const Modalisttext28Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext28Widget> createState() => _Modalisttext28WidgetState();
}

class _Modalisttext28WidgetState extends State<Modalisttext28Widget> {
  late Modalisttext28Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext28Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv19Record>>(
      stream: queryVocalistLv19Record(
        queryBuilder: (vocalistLv19Record) => vocalistLv19Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv19Record> containerVocalistLv19RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv19RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv19Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal28(
                                            containerVocalistLv19RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv19Record>();
                                    setState(() {});
                                  },
