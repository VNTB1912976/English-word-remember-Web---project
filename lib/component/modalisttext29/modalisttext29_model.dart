...
import 'modalisttext29_widget.dart' show Modalisttext29Widget;
import 'package:flutter/material.dart';

class Modalisttext29Model extends FlutterFlowModel<Modalisttext29Widget> {
  ///  Local state fields for this component.

  List<VocalistLv9Record> promotevoca = [];
  void addToPromotevoca(VocalistLv9Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv9Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv9Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv9Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv9Record>();
