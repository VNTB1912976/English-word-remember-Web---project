...
import 'modalisttext30_widget.dart' show Modalisttext30Widget;
import 'package:flutter/material.dart';

class Modalisttext30Model extends FlutterFlowModel<Modalisttext30Widget> {
  ///  Local state fields for this component.

  List<VocalistLv21Record> promotevoca = [];
  void addToPromotevoca(VocalistLv21Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv21Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv21Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv21Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv21Record>();
