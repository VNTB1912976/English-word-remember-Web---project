...
import 'modalisttext30_model.dart';
export 'modalisttext30_model.dart';

class Modalisttext30Widget extends StatefulWidget {
  const Modalisttext30Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext30Widget> createState() => _Modalisttext30WidgetState();
}

class _Modalisttext30WidgetState extends State<Modalisttext30Widget> {
  late Modalisttext30Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext30Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv21Record>>(
      stream: queryVocalistLv21Record(
        queryBuilder: (vocalistLv21Record) => vocalistLv21Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv21Record> containerVocalistLv21RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv21RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv21Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal30(
                                            containerVocalistLv21RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv21Record>();
                                    setState(() {});
                                  },
