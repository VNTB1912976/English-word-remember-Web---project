...
import 'modalisttext31_widget.dart' show Modalisttext31Widget;
import 'package:flutter/material.dart';

class Modalisttext31Model extends FlutterFlowModel<Modalisttext31Widget> {
  ///  Local state fields for this component.

  List<VocalistLv22Record> promotevoca = [];
  void addToPromotevoca(VocalistLv22Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv22Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv22Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv22Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv22Record>();
