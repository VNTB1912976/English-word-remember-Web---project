...
import 'modalisttext32_widget.dart' show Modalisttext32Widget;
import 'package:flutter/material.dart';

class Modalisttext32Model extends FlutterFlowModel<Modalisttext32Widget> {
  ///  Local state fields for this component.

  List<VocalistLv23Record> promotevoca = [];
  void addToPromotevoca(VocalistLv23Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv23Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv23Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv23Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv23Record>();
