...
import 'modalisttext32_model.dart';
export 'modalisttext32_model.dart';

class Modalisttext32Widget extends StatefulWidget {
  const Modalisttext32Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext32Widget> createState() => _Modalisttext32WidgetState();
}

class _Modalisttext32WidgetState extends State<Modalisttext32Widget> {
  late Modalisttext32Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext32Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv23Record>>(
      stream: queryVocalistLv23Record(
        queryBuilder: (vocalistLv23Record) => vocalistLv23Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv23Record> containerVocalistLv23RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv23RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv23Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal32(
                                            containerVocalistLv23RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv23Record>();
                                    setState(() {});
                                  },
