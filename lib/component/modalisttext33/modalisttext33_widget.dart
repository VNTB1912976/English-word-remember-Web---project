...
import 'modalisttext33_model.dart';
export 'modalisttext33_model.dart';

class Modalisttext33Widget extends StatefulWidget {
  const Modalisttext33Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext33Widget> createState() => _Modalisttext33WidgetState();
}

class _Modalisttext33WidgetState extends State<Modalisttext33Widget> {
  late Modalisttext33Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext33Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv24Record>>(
      stream: queryVocalistLv24Record(
        queryBuilder: (vocalistLv24Record) => vocalistLv24Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv24Record> containerVocalistLv24RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv24RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv24Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal33(
                                            containerVocalistLv24RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv24Record>();
                                    setState(() {});
                                  },
