...
import 'modalisttext34_model.dart';
export 'modalisttext34_model.dart';

class Modalisttext34Widget extends StatefulWidget {
  const Modalisttext34Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext34Widget> createState() => _Modalisttext34WidgetState();
}

class _Modalisttext34WidgetState extends State<Modalisttext34Widget> {
  late Modalisttext34Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext34Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv25Record>>(
      stream: queryVocalistLv25Record(
        queryBuilder: (vocalistLv25Record) => vocalistLv25Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv25Record> containerVocalistLv25RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv25RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv25Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal34(
                                            containerVocalistLv25RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv25Record>();
                                    setState(() {});
                                  },
