...
import 'modalisttext35_model.dart';
export 'modalisttext35_model.dart';

class Modalisttext35Widget extends StatefulWidget {
  const Modalisttext35Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext35Widget> createState() => _Modalisttext35WidgetState();
}

class _Modalisttext35WidgetState extends State<Modalisttext35Widget> {
  late Modalisttext35Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext35Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv26Record>>(
      stream: queryVocalistLv26Record(
        queryBuilder: (vocalistLv26Record) => vocalistLv26Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv26Record> containerVocalistLv26RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv26RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv26Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal35(
                                            containerVocalistLv26RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv26Record>();
                                    setState(() {});
                                  },
