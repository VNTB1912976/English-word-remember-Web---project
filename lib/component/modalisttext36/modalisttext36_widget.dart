...
import 'modalisttext36_model.dart';
export 'modalisttext36_model.dart';

class Modalisttext36Widget extends StatefulWidget {
  const Modalisttext36Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext36Widget> createState() => _Modalisttext36WidgetState();
}

class _Modalisttext36WidgetState extends State<Modalisttext36Widget> {
  late Modalisttext36Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext36Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv27Record>>(
      stream: queryVocalistLv27Record(
        queryBuilder: (vocalistLv27Record) => vocalistLv27Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv27Record> containerVocalistLv27RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv27RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv27Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal36(
                                            containerVocalistLv27RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv27Record>();
                                    setState(() {});
                                  },
