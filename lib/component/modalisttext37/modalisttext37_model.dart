...
import 'modalisttext37_widget.dart' show Modalisttext37Widget;
import 'package:flutter/material.dart';

class Modalisttext37Model extends FlutterFlowModel<Modalisttext37Widget> {
  ///  Local state fields for this component.

  List<VocalistLv28Record> promotevoca = [];
  void addToPromotevoca(VocalistLv28Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv28Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv28Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv28Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv28Record>();
