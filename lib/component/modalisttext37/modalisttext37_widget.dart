...
import 'modalisttext37_model.dart';
export 'modalisttext37_model.dart';

class Modalisttext37Widget extends StatefulWidget {
  const Modalisttext37Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext37Widget> createState() => _Modalisttext37WidgetState();
}

class _Modalisttext37WidgetState extends State<Modalisttext37Widget> {
  late Modalisttext37Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext37Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv28Record>>(
      stream: queryVocalistLv28Record(
        queryBuilder: (vocalistLv28Record) => vocalistLv28Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv28Record> containerVocalistLv28RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv28RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv28Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal37(
                                            containerVocalistLv28RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv28Record>();
                                    setState(() {});
                                  },
