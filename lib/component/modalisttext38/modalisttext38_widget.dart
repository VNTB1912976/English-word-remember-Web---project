...
import 'modalisttext38_model.dart';
export 'modalisttext38_model.dart';

class Modalisttext38Widget extends StatefulWidget {
  const Modalisttext38Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext38Widget> createState() => _Modalisttext38WidgetState();
}

class _Modalisttext38WidgetState extends State<Modalisttext38Widget> {
  late Modalisttext38Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext38Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv29Record>>(
      stream: queryVocalistLv29Record(
        queryBuilder: (vocalistLv29Record) => vocalistLv29Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv29Record> containerVocalistLv29RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv29RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv29Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal38(
                                            containerVocalistLv29RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv29Record>();
                                    setState(() {});
                                  },
