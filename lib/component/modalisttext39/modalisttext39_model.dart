...
import 'modalisttext39_widget.dart' show Modalisttext39Widget;
import 'package:flutter/material.dart';

class Modalisttext39Model extends FlutterFlowModel<Modalisttext39Widget> {
  ///  Local state fields for this component.

  List<VocalistLv30Record> promotevoca = [];
  void addToPromotevoca(VocalistLv30Record item) => promotevoca.add(item);
  void removeFromPromotevoca(VocalistLv30Record item) =>
      promotevoca.remove(item);
  void removeAtIndexFromPromotevoca(int index) => promotevoca.removeAt(index);
  void insertAtIndexInPromotevoca(int index, VocalistLv30Record item) =>
      promotevoca.insert(index, item);
  void updatePromotevocaAtIndex(
          int index, Function(VocalistLv30Record) updateFn) =>
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<VocalistLv30Record>();
