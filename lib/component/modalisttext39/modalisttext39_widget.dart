...
import 'modalisttext39_model.dart';
export 'modalisttext39_model.dart';

class Modalisttext39Widget extends StatefulWidget {
  const Modalisttext39Widget({
    super.key,
    int? numberofRows,
  ...
  @override
  State<Modalisttext39Widget> createState() => _Modalisttext39WidgetState();
}

class _Modalisttext39WidgetState extends State<Modalisttext39Widget> {
  late Modalisttext39Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modalisttext39Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VocalistLv30Record>>(
      stream: queryVocalistLv30Record(
        queryBuilder: (vocalistLv30Record) => vocalistLv30Record.orderBy('num'),
      ),
      builder: (context, snapshot) {
        ...
        List<VocalistLv30Record> containerVocalistLv30RecordList =
            snapshot.data!;
        return Container(
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final vocal =
                                    containerVocalistLv30RecordList.toList();
                                return FlutterFlowDataTable<VocalistLv30Record>(
                                  controller:
                                ...
                                _model.instantTimer = InstantTimer.periodic(
                                  ...
                                  callback: (timer) async {
                                    ...
                                    _model.promotevoca = functions
                                        .findPromotedEmpsVocal39(
                                            containerVocalistLv30RecordList
                                                .toList(),
                                            _model.paginatedDataTableController
                                                .selectedRows
                                                .toList())
                                        .toList()
                                        .cast<VocalistLv30Record>();
                                    setState(() {});
                                  },
