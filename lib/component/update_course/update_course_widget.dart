...
class UpdateCourseWidget extends StatefulWidget {
  const UpdateCourseWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CourseRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CourseRecord> optionsCourseRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final optionsCourseRecord = optionsCourseRecordList.isNotEmpty
            ? optionsCourseRecordList.first
            : null;
        return Material(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          8.0, 0.0, 8.0, 0.0),
                                      child: TextFormField(
                                        controller: _model.msTextController ??=
                                            TextEditingController(
                                          text: optionsCourseRecord?.ms,
                                        ),
                                        focusNode: _model.msFocusNode,
                                        autofocus: true,
                                        obscureText: false,
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.nameTextController ??=
                                                TextEditingController(
                                          text: optionsCourseRecord?.vocaName,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.descriptionTextController ??=
                                                TextEditingController(
                                          text:
                                              optionsCourseRecord?.description,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.priceTextController ??=
                                                TextEditingController(
                                          text: optionsCourseRecord?.price,
                                        ),
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await optionsCourseRecord!.reference
                                          .update(createCourseRecordData(
                                        ms: _model.msTextController.text,
                                        vocaName:
