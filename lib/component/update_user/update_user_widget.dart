...
class _UpdateUserWidgetState extends State<UpdateUserWidget> {
  ...
  void initState() {
    ...
    _model.payerFocusNode ??= FocusNode();

    _model.moneyFocusNode ??= FocusNode();

    _model.noteFocusNode ??= FocusNode();

    _model.timeTextController ??= TextEditingController(text: '1');
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.companyTextController ??=
                                                  TextEditingController(
                                            text: optionsUsersRecord?.company,
                                          ),
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.phoneTextController ??=
                                                  TextEditingController(
                                            text:
                                                optionsUsersRecord?.phoneNumber,
                                          ),
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.addressTextController ??=
                                                  TextEditingController(
                                            text: optionsUsersRecord?.address,
                                          ),
                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.payerTextController ??=
                                                  TextEditingController(
                                            text: optionsUsersRecord?.payer,
                                          ),
                                          focusNode: _model.payerFocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText: '입금자',
                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.moneyTextController ??=
                                                  TextEditingController(
                                            text: optionsUsersRecord?.money,
                                          ),
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                final datePicked1Date = await showDatePicker(
                                  context: context,
                                  initialDate: (optionsUsersRecord?.startDate ??
                                      DateTime.now()),
                                ...
                                _model.setTime1 = await actions.setTime(
                                  valueOrDefault<int>(
                                    int.tryParse(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                final datePicked2Date = await showDatePicker(
                                  context: context,
                                  initialDate: (optionsUsersRecord?.endDate ??
                                      DateTime.now()),
                                  firstDate: DateTime(1900),
                                  lastDate: DateTime(2050),
                                  builder: (context, child) {
                                ...
                                _model.setTime = await actions.setTime(
                                  valueOrDefault<int>(
                                    int.tryParse(
                                        _model.timeTextController.text),
                                    1,
                                    ...
                                    FlutterFlowDropDown<String>(
                                      controller:
                                        ...
                                        _model.dropDownValue ??=
                                            optionsUsersRecord?.typeUser,
                                      ),
                                      options: const ['student', 'user'],
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        await optionsUsersRecord!.reference
                                          ...
                                          payer:
                                              _model.payerTextController.text,
                                          note: _model.noteTextController.text,
                                          time: _model.setTimebt,
                                        ));
                                        Navigator.pop(context);
