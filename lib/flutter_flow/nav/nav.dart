      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => HomeWidget(
            colorcontainer: params.getParam(
              'colorcontainer',
              ParamType.Color,
            ),
            checkboxvocal: params.getParam(
              'checkboxvocal',
              ParamType.bool,
            ),
          ),
        ...
        FFRoute(
          name: 'AdminUser',
          path: '/adminUser',
          builder: (context, params) => const AdminUserWidget(),
        ),
        FFRoute(
          name: 'AdminStudent',
          path: '/adminStudent',
        ...
        FFRoute(
          name: 'infomationUser',
          path: '/RegisterUser',
          builder: (context, params) => const InfomationUserWidget(),
        ),
        FFRoute(
          name: 'infomationStudent',
          path: '/RegisterStudent',
          builder: (context, params) => const InfomationStudentWidget(),
        )
